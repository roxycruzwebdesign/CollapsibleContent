...
/**
 * Generate all the supported features for the given post type.
 *
 * @since 1.0.0
 *
 ...
 * 
 * @param  array  $supported_features  Array of supported post type features
 * @param  array $additional_features The additional features to merge with our supported featurs.
 *                                            
 * @return array
 */
